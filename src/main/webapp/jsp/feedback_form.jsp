...
<% 
	org.springframework.validation.BindingResult bindingResult = 
		(org.springframework.validation.BindingResult)renderRequest.getAttribute("org.springframework.validation.BindingResult.feedback"); 
%>

<div id="content-primary" class="article cf" role="main">
	<h1>Lämna synpunkter på Återvinsten</h1>
...
%>	
	...
	<form:form id="feedback-form" cssClass="form-general" modelAttribute="feedback" action="${sendMailUrl}" >
