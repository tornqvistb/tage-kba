...
<portlet:renderURL var="listRequestsUrl"><portlet:param name="page" value="listRequests"/></portlet:renderURL>
<div id="m-requested-items" class="m m-link-list">
	<div class="content-header cf">
		<a href="${listRequestsUrl}" class="button">Alla efterlysningar</a>
