	...
	<form:form id="new-want-ad-form" cssClass="form-general" modelAttribute="request" action="${saveRequestUrl}" >
		...
		<div class="row cols-1 cf">
			<div class="file col full col-1">
				...
				<p class="info-message">Beskriv i texten ovan om bilden föreställer exakt det du letar efter eller om det är något liknande.
										Minsta storlek på bild är 300 * 300 pixlar och du kan lägga upp fler bilder.
				</p>
				<!-- upload -->
