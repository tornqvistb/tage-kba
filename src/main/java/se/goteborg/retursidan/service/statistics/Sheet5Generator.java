...
public class Sheet5Generator extends BaseSheetGenerator {
	
    public Sheet5Generator(Workbook workbook, Map<String, Object> model) {
		super(workbook, model);
	}
	
    public void createSheet() {
    	Sheet sheet = workbook.createSheet("Efterl. totalt + per mån., år");
        ...
        pageHeaderCell.setCellValue("Antal publicerade efterlysningar per månad, per år och totalt");
        ...
        headerCell.setCellStyle(headerStyle);
        headerCell.setCellValue("Antal publicerade efterlysningar");
